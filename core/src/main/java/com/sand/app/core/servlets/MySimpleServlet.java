...
@Component(
	...
	property={
	    ...
	    "sling.servlet.paths="+ "/bin/getMorningNews",
...
@Component(
	service=Servlet.class,
	property={
	    Constants.SERVICE_DESCRIPTION + "=My Simple Demo Servlet",
	    "sling.servlet.paths=" + "/bin/getMorningNews",
	    "sling.servlet.methods=" + HttpConstants.METHOD_GET,
	    "sling.servlet.extensions=" + "txt"
	}
...
public class MySimpleServlet extends SlingSafeMethodsServlet {
    ...
    protected void doGet(final SlingHttpServletRequest req,
    	...
    	Logger LOGGER = LoggerFactory.getLogger(MySimpleServlet.class);
    	LOGGER.info("Ready To Get?");
...
public class MySimpleServlet extends SlingSafeMethodsServlet {
    private static final Logger LOGGER = LoggerFactory
            .getLogger(MySimpleServlet.class);
